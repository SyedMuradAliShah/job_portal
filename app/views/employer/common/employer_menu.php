<ul class="featurlist">
      ...
      <li><a href="<?php echo base_url('employer/chat'); ?>" class="innerfetbox" <?php echo is_active_like($this->uri->segment(2), 'chat'); ?>><i class="fa fa-comment"></i> <span>Chat</span></a></li>
      <div class="clear"></div>
