            ...
            <div class="col-md-12">
              <div class="userinfoWrp">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('employer/edit_company'); ?>" id="edit_company_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> Edit Company Profile</a>
                </div>
                <div class="clear"></div>
              </div>
            </div>
            ...
            <div class="row searchlist">
              ...
              ?>
                  <div class="col-md-12" id="pj_<?php echo $row_jobs->ID; ?>">
                    <div class="intlist">
                      <div class="col-md-12">
                        <div class="col-md-5"> <a href="<?php echo base_url('jobs/' . $row_jobs->job_slug); ?>" class="jobtitle"><?php echo word_limiter(strip_tags($row_jobs->job_title), 9); ?></a>
