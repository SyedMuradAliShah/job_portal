<ul class="featurlist">
  ...
  <li><a href="<?php echo base_url('jobseeker/build_cv'); ?>" class="innerfetbox <?php echo is_active_like($this->uri->segment(2), 'build_cv'); ?>"><i class="fa fa-cog"></i> <span>Build a CV</span></a></li>
  ...
  <li><a href="<?php echo base_url('jobseeker/chat'); ?>" class="innerfetbox" <?php echo is_active_like($this->uri->segment(2), 'chat'); ?>><i class="fa fa-comment"></i> <span>Chat</span></a></li>
  <div class="clear"></div>
