            ...
            <div class="col-md-12">
              <div class="userinfoWrp">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('jobseeker/my_account'); ?>" id="edit_jobseeker_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> Edit Profile</a>
                </div>
                <div class="clear"></div>
              </div>
            </div>
          ...
          <div class="innerbox2">
            <div class="titlebar">
              <div class="row">
                ...
                <div class="col-md-5 text-right"><a href="<?php echo base_url('jobseeker/cv_manager'); ?>">CV Manager</a>
                  <!--<a href="#">Upload CV</a>--> <a href="<?php echo base_url('jobseeker/build_cv'); ?>">Build a CV</a></div>
              </div>
            </div>
            ...
            <div class="experiance">
              <ul class="myjobList"> 
                ...
                if ($userCV) :
                  ...
                  $encrypt_id = $this->custom_encryption->encrypt_data($this->session->userdata('user_id'));
                ?>
                  <li class="row">
                    <div class="col-md-4 ">
                ...
                ?>
                    <li class="row" id="cv_<?php echo $row_resume->ID; ?>">
                      ...
                      <div class="col-md-2"><?php //echo ($row_resume->is_default_resume=='yes')?'Default':'Mark as Default';
                                            ?></div>
